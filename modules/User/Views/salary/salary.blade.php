        ...
        <div class="card-body">
            <ul class="nav nav-pills" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" id="profile-tab"
                       href="{{ route('get.profile.update') }}">{{ trans('Profile') }}</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content p-4">
                <div class="tab-pane fade show active" id="salary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        <span class="text-success">{{ $user->getCommissionRate() }}%</span>
                                    </div>
                                </div>
                                @if($target_by === \Modules\Setting\Model\CommissionRateSetting::PERSON_INCOME)
                                    <div class="form-group row">
                    ...
                    <div id="order-list" class="listing">
