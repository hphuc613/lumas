...
<div class="tab-content">
                ...
                @foreach($member_services as $value)
                    ...
                    <tr>
                        ...
                        <td class="link-action">
                            ...
                            <a href="{{ route('get.member_service.into_progress',$value->id) }}" class="btn btn-info">
    ...
    <div
        class="tab-pane fade @if(isset($filter['code_completed']) || isset($filter['service_search_completed'])) show active @endif"
