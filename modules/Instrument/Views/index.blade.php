...
@section('content')
    <div id="instrument-module">
        <div class="breadcrumb-line">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">{{ trans('Home') }}</a></li>
                    <li class="breadcrumb-item"><a href="#">{{ trans('Instrument Listing') }}</a></li>
                </ol>
            </nav>
        </div>
        <div id="head-page" class="d-flex justify-content-between">
            <div class="page-title"><h3>{{ trans('Instrument Listing') }}</h3></div>
            <div class="group-btn">
                <a href="{{ route('get.instrument.create') }}" class="btn btn-main-color" data-toggle="modal"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="text-input">{{ trans('Instrument name') }}</label>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            @php($key = ($instruments->currentpage()-1)*$instruments->perpage()+1)
                        ...
                        <div class="mt-5 pagination-style">
                            {{ $instruments->withQueryString()->render('vendor.pagination.default') }}
                        </div>
                    </div>
                </div>
            </div>
